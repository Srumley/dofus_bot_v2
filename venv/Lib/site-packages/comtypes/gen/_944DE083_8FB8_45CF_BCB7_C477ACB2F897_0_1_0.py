...
__all__ = [
    ...
    'AnnotationType_FormatChange', 'UIA_DocumentControlTypeId',
    'UIA_IsPeripheralPropertyId',
    'AnnotationType_DataValidationError', 'HeadingLevel6',
    'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_ControllerForPropertyId',
    'UIA_WindowWindowVisualStatePropertyId', 'UIA_TransformPatternId',
    'IUIAutomationProxyFactoryEntry',
    'UIA_AnnotationAuthorPropertyId', 'UIA_DragPatternId',
    'NotificationKind_ActionCompleted',
    'UIA_Transform2ZoomLevelPropertyId', 'IUIAutomationDockPattern',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_IsEnabledPropertyId', 'WindowVisualState_Normal',
    'UIA_FontNameAttributeId', 'UIA_FontWeightAttributeId',
    'NotificationProcessing', 'IUIAutomationEventHandlerGroup',
    'AnnotationType_Highlighted', 'IUIAutomationElementArray',
    'UIA_ImageControlTypeId', 'UIA_DragDropEffectsPropertyId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_WindowIsModalPropertyId', 'UIA_StyleIdAttributeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_GridItemPatternId', 'UIA_IsOffscreenPropertyId',
    'NavigateDirection_LastChild', 'UIA_ValueValuePropertyId',
    'Polite', 'AutomationElementMode', 'AnnotationType_Unknown',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'IUIAutomationItemContainerPattern',
    'UIA_IndentationTrailingAttributeId',
    'SynchronizedInputType_LeftMouseUp', 'UIA_EditControlTypeId',
    'AnnotationType_FormulaError', 'StyleId_Heading1',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_TableRowHeadersPropertyId', 'TextPatternRangeEndpoint_End',
    'StyleId_Heading7', 'CoalesceEventsOptions_Enabled',
    'UIA_ToolBarControlTypeId', 'OrientationType',
    'UIA_AsyncContentLoadedEventId',
    'ProviderOptions_UseClientCoordinates',
    'IUIAutomationOrCondition', 'HeadingLevel9',
    'IUIAutomationInvokePattern', 'UIA_RadioButtonControlTypeId',
    ...
    'IUIAutomationScrollItemPattern', 'IUIAutomationTextRangeArray',
    'SynchronizedInputType_RightMouseDown',
    'NotificationKind_ItemRemoved',
    'UIA_IsTransformPatternAvailablePropertyId',
    'IUIAutomationObjectModelPattern', 'PropertyConditionFlags',
    'StyleId_Subtitle', 'TreeScope_Ancestors',
    'UIA_TableItemPatternId', 'DockPosition_Left',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'TreeTraversalOptions', 'UIA_MenuBarControlTypeId',
    'IUIAutomationTextPattern', 'AnnotationType_ExternalChange',
    'UIA_LinkAttributeId', 'IUIAutomationValuePattern',
    'UIA_IsSubscriptAttributeId', 'StructureChangeType_ChildRemoved',
    'UIA_StructureChangedEventId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_IsReadOnlyAttributeId', 'ProviderOptions_OverrideProvider',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId', 'UIA_StylesPatternId',
    'TreeTraversalOptions_Default', 'StyleId_Heading6',
    'StyleId_Heading9', 'NotificationKind_ItemAdded',
    ...
    'WindowInteractionState_Running', 'UIA_MarginLeadingAttributeId',
    'IUIAutomationChangesEventHandler', 'UIA_DropTargetPatternId',
    ...
    'IUIAutomation', 'UIA_AnnotationPatternId', 'TreeScope_Children',
    'UIA_FrameworkIdPropertyId', 'TextEditChangeType_None',
    'UIA_SelectionActiveEndAttributeId', 'UIA_SearchLandmarkTypeId',
    'ScrollAmount_LargeIncrement', 'UIA_GridPatternId',
    'ConnectionRecoveryBehaviorOptions', 'UIA_IsDialogPropertyId',
    'UIA_NativeWindowHandlePropertyId', 'IUIAutomationElement5',
    'TextUnit_Word', 'StyleId_Heading3', 'IUIAutomationElement2',
    'IUIAutomationStylesPattern', 'IUIAutomationTextChildPattern',
    'UIA_DragDropEffectPropertyId', 'IUIAutomationTreeWalker',
    'UIA_IsContentElementPropertyId', 'UIA_InvokePatternId',
    'UIA_NotificationEventId', 'UIA_IsHiddenAttributeId',
    'UIA_Window_WindowOpenedEventId', 'StyleId_Heading4',
    'UIA_SelectionPatternId', 'HeadingLevel8',
    'UIA_CaretBidiModeAttributeId', 'RowOrColumnMajor',
    'UIA_AnnotationTypesAttributeId', 'IUIAutomation3',
    'StyleId_Custom', 'UIA_OutlineColorPropertyId', 'LiveSetting',
    'IUIAutomation2', 'UIA_OutlineStylesAttributeId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'IUIAutomationSelectionPattern', 'NavigateDirection',
    'NotificationProcessing_ImportantAll',
    'IUIAutomationCacheRequest', 'UIA_Drag_DragCompleteEventId',
    'UIA_BackgroundColorAttributeId', 'UIA_MarginTrailingAttributeId',
    'UIA_AutomationIdPropertyId', 'UIA_ToolTipClosedEventId',
    'UIA_Window_WindowClosedEventId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_TextControlTypeId', 'UIA_SplitButtonControlTypeId',
    'AnnotationType_UnsyncedChange', 'UIA_HeaderItemControlTypeId',
    'TextUnit', 'UIA_DropTarget_DragEnterEventId',
    'IUIAutomationTextPattern2', 'StyleId_BulletedList',
    ...
    'UIA_FontSizeAttributeId', 'UIA_StylesFillPatternColorPropertyId',
    'IUIAutomationProxyFactoryMapping', 'WindowInteractionState',
    'IUIAutomationDropTargetPattern',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_ButtonControlTypeId', 'UIA_TablePatternId',
    'UIA_WindowCanMinimizePropertyId',
    'IUIAutomationTransformPattern2',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_TransformCanRotatePropertyId', 'UIA_SeparatorControlTypeId',
    'HeadingLevel5', 'UIA_LandmarkTypePropertyId',
    'UIA_SemanticZoomControlTypeId', 'TreeScope_Descendants',
    'WindowInteractionState_NotResponding',
    'UIA_AcceleratorKeyPropertyId', 'UIA_SizePropertyId',
    'OrientationType_Horizontal', 'UIA_ExpandCollapsePatternId',
    'TextPatternRangeEndpoint', 'SupportedTextSelection_Single',
    'UIA_HasKeyboardFocusPropertyId', 'IUIAutomationGridItemPattern',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_LevelPropertyId', 'AnnotationType_ConflictingChange',
    'SupportedTextSelection_Multiple',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_TableRowOrColumnMajorPropertyId', 'UIA_TabControlTypeId',
    'OrientationType_Vertical', 'UIA_ItemTypePropertyId',
    'UIA_TextPattern2Id', 'SynchronizedInputType_KeyUp',
    'UIA_IsPasswordPropertyId', 'UIA_SynchronizedInputPatternId',
    'SynchronizedInputType_RightMouseUp',
    'IUIAutomationPropertyChangedEventHandler',
    'AnnotationType_SpellingError', 'ExpandCollapseState',
    'UIA_FillColorPropertyId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_ProcessIdPropertyId', 'IUIAutomationGridPattern',
    'UIA_DataGridControlTypeId', 'TextEditChangeType_AutoComplete',
    'UIA_DropTarget_DroppedEventId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_ProgressBarControlTypeId', 'UIA_OutlineThicknessPropertyId',
    ...
    'UIA_LayoutInvalidatedEventId', 'UIA_StatusBarControlTypeId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_HyperlinkControlTypeId', 'IUIAutomationElement8',
    'UIA_AnnotationObjectsPropertyId',
    'UIA_TransformCanMovePropertyId',
    'IUIAutomationNotificationEventHandler', 'UiaChangeInfo',
    'UIA_LegacyIAccessibleStatePropertyId',
    'IUIAutomationTableItemPattern',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_ComboBoxControlTypeId',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_IsKeyboardFocusablePropertyId', 'UIA_CheckBoxControlTypeId',
    'NavigateDirection_FirstChild',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_Drag_DragStartEventId', 'NotificationKind_ActionAborted',
    'Assertive', 'AnnotationType_InsertionChange',
    'WindowVisualState', 'IUIAutomationMultipleViewPattern',
    'UIA_ProviderDescriptionPropertyId',
    'IUIAutomationAnnotationPattern', 'AnnotationType_Footer',
    ...
    'ProviderOptions_ClientSideProvider', 'StyleId_Heading2',
    'StructureChangeType_ChildrenInvalidated',
    'IUIAutomationElement4', 'UIA_AutomationFocusChangedEventId',
    'SupportedTextSelection', 'TextUnit_Character',
    'IUIAutomationPropertyCondition', 'DockPosition_None',
    'UIA_SummaryChangeId', 'UIA_ScrollVerticalViewSizePropertyId',
    'IUIAutomationTablePattern', 'SynchronizedInputType',
    'UIA_CaretPositionAttributeId', 'IUIAutomation5',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_ScrollItemPatternId', 'AnnotationType_Sensitive',
    'DockPosition_Right', 'IUIAutomationSpreadsheetPattern',
    'UIA_NamePropertyId', 'NotificationKind_Other',
    'UIA_HeaderControlTypeId', 'AnnotationType_Comment',
    'IUIAutomationNotCondition', 'TextEditChangeType',
    'UIA_Invoke_InvokedEventId',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'ZoomUnit',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_ForegroundColorAttributeId', 'UIA_AnimationStyleAttributeId',
    'UIA_ScrollVerticallyScrollablePropertyId', 'ToggleState_Off',
    'ScrollAmount_SmallIncrement',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_IsItalicAttributeId',
    'UIA_PaneControlTypeId', 'UIA_LocalizedLandmarkTypePropertyId',
    'CUIAutomation', 'RowOrColumnMajor_ColumnMajor',
    'UIA_ClickablePointPropertyId', 'UIA_RangeValueMinimumPropertyId',
    'StyleId_Emphasis', 'ZoomUnit_LargeIncrement',
    'UIA_CulturePropertyId', 'AnnotationType_Endnote',
    'IUIAutomationTextEditPattern', 'IUIAutomationElement',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'ProviderOptions_ServerSideProvider',
    'UIA_Selection_InvalidatedEventId', 'WindowVisualState_Minimized',
    'UIA_SpreadsheetItemPatternId',
    'UIA_IsTransformPattern2AvailablePropertyId', 'Off',
    'NavigateDirection_Parent', 'UIA_CustomNavigationPatternId',
    ...
    'UIA_ListControlTypeId', 'TextEditChangeType_AutoCorrect',
    'AnnotationType_DeletionChange', 'AnnotationType_Author',
    'IUIAutomationEventHandler', 'UIA_CustomLandmarkTypeId',
    'UIA_MarginBottomAttributeId', 'UIA_OverlineStyleAttributeId',
    ...
    'UIA_IsDockPatternAvailablePropertyId', 'UIA_RangeValuePatternId',
    'UIA_SliderControlTypeId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_VirtualizedItemPatternId', 'UIA_AriaPropertiesPropertyId',
    'IUIAutomationProxyFactory', 'UIA_DataItemControlTypeId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'IUIAutomationTransformPattern', 'IUIAutomationScrollPattern',
    'UIA_LineSpacingAttributeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_Text_TextChangedEventId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_CenterPointPropertyId', 'UIA_SizeOfSetPropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_ClassNamePropertyId', 'ExtendedProperty',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_GridRowCountPropertyId', 'IUIAutomationSelectionPattern2',
    'DockPosition', 'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_TreeControlTypeId', 'UIA_TitleBarControlTypeId',
    'TreeScope_Element', 'IUIAutomationBoolCondition',
    'ZoomUnit_SmallIncrement', 'ToggleState_On',
    'CoalesceEventsOptions_Disabled', 'ToggleState_Indeterminate',
    'IUIAutomationAndCondition', 'DockPosition_Bottom',
    'TextUnit_Line', 'UIA_OptimizeForVisualContentPropertyId',
    'UIA_WindowIsTopmostPropertyId', 'SynchronizedInputType_KeyDown',
    'UIA_BoundingRectanglePropertyId', 'CUIAutomation8',
    'IUIAutomationSelectionItemPattern', 'StyleId_Normal',
    'UIA_IsDataValidForFormPropertyId',
    'UIA_AnnotationTypesPropertyId', 'UIA_BulletStyleAttributeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'PropertyConditionFlags_IgnoreCase',
    'ExpandCollapseState_Collapsed', 'TreeScope',
    'ZoomUnit_SmallDecrement', 'UIA_GridItemContainingGridPropertyId',
    'TextUnit_Page', 'StructureChangeType',
    'UIA_SpreadsheetPatternId', 'UIA_LiveRegionChangedEventId',
    'UIA_TextChildPatternId', 'OrientationType_None',
    'UIA_LiveSettingPropertyId', 'UIA_StylesStyleIdPropertyId',
    'UIA_TransformCanResizePropertyId', 'AutomationElementMode_Full',
    'UIA_StyleNameAttributeId', 'RowOrColumnMajor_Indeterminate',
    'HeadingLevel1', 'UIA_InputDiscardedEventId',
    'UIA_MenuClosedEventId', 'AnnotationType_Footnote',
    'UIA_Selection2ItemCountPropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_SelectionItem_ElementSelectedEventId',
    'ScrollAmount_LargeDecrement', 'UIA_AriaRolePropertyId',
    'UIA_MenuControlTypeId', 'UIA_LocalizedControlTypePropertyId',
    'UIA_SystemAlertEventId', 'IUIAutomationVirtualizedItemPattern',
    'UIA_IsWindowPatternAvailablePropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_MultipleViewPatternId', 'UIA_ScrollPatternId',
    'UIA_HelpTextPropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_StrikethroughStyleAttributeId', 'UIA_DockPatternId',
    'ExpandCollapseState_Expanded', 'UIA_TableControlTypeId',
    'UIA_DockDockPositionPropertyId',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_IndentationLeadingAttributeId',
    'UIA_StylesStyleNamePropertyId', 'UIA_TreeItemControlTypeId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'IUIAutomationCustomNavigationPattern', 'IUIAutomationElement9',
    'UIA_ControlTypePropertyId', 'UIA_WindowControlTypeId',
    'IUIAutomationElement6', 'ScrollAmount_SmallDecrement',
    'ZoomUnit_LargeDecrement', 'IUIAutomationTextRange3',
    'IUIAutomation6', 'UIA_SelectionIsSelectionRequiredPropertyId',
    'StyleId_Heading8', 'UIA_PositionInSetPropertyId',
    'UIA_TabsAttributeId', 'UIA_IsControlElementPropertyId',
    'HeadingLevel7', 'UIA_SpinnerControlTypeId',
    'UIA_TransformPattern2Id', 'UIA_AfterParagraphSpacingAttributeId',
    'AnnotationType_EditingLockedChange', 'UIA_AccessKeyPropertyId',
    'IUIAutomationRangeValuePattern', 'StyleId_Title',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_MenuItemControlTypeId', 'IRawElementProviderSimple',
    'HeadingLevel3', 'UIA_IndentationFirstLineAttributeId',
    'UIA_OverlineColorAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_FlowsFromPropertyId', 'WindowInteractionState_Closing',
    'UIA_TextEditPatternId', 'UIA_RangeValueIsReadOnlyPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'UIA_ToolTipOpenedEventId', 'UIA_CalendarControlTypeId',
    'TextUnit_Format', 'PropertyConditionFlags_None',
    'IUIAutomationExpandCollapsePattern', 'UIA_TabItemControlTypeId',
    'UIA_ChangesEventId', 'UIA_DragIsGrabbedPropertyId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_ToolTipControlTypeId',
    'UIA_IsStylesPatternAvailablePropertyId', 'ScrollAmount_NoAmount',
    'TreeTraversalOptions_PostOrder', 'UIA_IsSuperscriptAttributeId',
    'StyleId_Quote', 'UIA_ItemContainerPatternId',
    'StructureChangeType_ChildAdded', 'StyleId_Heading5',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_IsActiveAttributeId', 'TextUnit_Paragraph',
    'UIA_OrientationPropertyId', 'UIA_MenuOpenedEventId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_FullDescriptionPropertyId', 'WindowVisualState_Maximized',
    'UIA_NavigationLandmarkTypeId', 'UIA_SelectionItemPatternId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'NavigateDirection_PreviousSibling', 'UIA_ItemStatusPropertyId',
    'IUIAutomationElement3', 'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_WindowCanMaximizePropertyId', 'IUIAutomationWindowPattern',
    'ToggleState', 'IAccessible',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'AnnotationType_TrackChanges', 'UIA_ListItemControlTypeId',
    'AutomationElementMode_None', 'UIA_WindowPatternId',
    'UIA_Transform2CanZoomPropertyId',
    'ProviderOptions_HasNativeIAccessible', 'UIA_CapStyleAttributeId',
    'UIA_AnnotationTargetPropertyId',
    'UIA_IsRequiredForFormPropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_FormLandmarkTypeId',
    'UIA_TextPatternId', 'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_GridItemColumnPropertyId', 'UIA_ScrollBarControlTypeId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_StylesFillColorPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'ScrollAmount',
    'DockPosition_Fill', 'TreeScope_Parent',
    'UIA_GridItemRowPropertyId', 'UIA_RotationPropertyId',
    'UIA_SelectionPattern2Id', 'UIA_AppBarControlTypeId',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'SupportedTextSelection_None', 'IUIAutomationDragPattern',
    'UIA_MainLandmarkTypeId', 'AnnotationType_Header',
    'TextEditChangeType_Composition',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_GridItemRowSpanPropertyId', 'UIA_TogglePatternId',
    'IUIAutomation4', 'UIA_AnnotationDateTimePropertyId',
    'UIA_IsDragPatternAvailablePropertyId',
    'UIA_DragGrabbedItemsPropertyId', 'DockPosition_Top',
    ...
    'UIA_LegacyIAccessibleNamePropertyId', 'CoalesceEventsOptions',
    'HeadingLevel4', 'UIA_ObjectModelPatternId',
    'NotificationProcessing_MostRecent', 'UIA_ThumbControlTypeId',
    'AnnotationType_MoveChange', 'UIA_ValuePatternId',
    'ZoomUnit_NoAmount',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'NavigateDirection_NextSibling', 'UIA_DescribedByPropertyId',
    'TextPatternRangeEndpoint_Start', 'TreeScope_Subtree',
    'ExpandCollapseState_LeafNode',
    'UIA_SelectionSelectionPropertyId', 'UIA_RuntimeIdPropertyId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'SynchronizedInputType_LeftMouseDown', 'IUIAutomationCondition',
    'UIA_CultureAttributeId', 'NotificationKind',
    'IUIAutomationTogglePattern', 'IUIAutomationTextRange',
    'UIA_UnderlineColorAttributeId', 'UIA_LabeledByPropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_AutomationPropertyChangedEventId', 'IUIAutomationElement7',
    'HeadingLevel_None', 'NotificationProcessing_All',
    'UIA_AnnotationObjectsAttributeId', 'RowOrColumnMajor_RowMajor',
    'AnnotationType_GrammarError'
]

_check_version('1.1.14', 1668420349.051010)
